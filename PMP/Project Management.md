...
# Ideas
- git 中的tag本质上是项目管理的一部分. 如果把每个版本的发布看做是一个milestone, 那标志着项目的结束
- 项目经理的视角
	- 我们进行一个办公室组网和搬迁
		- 项目的构想阶段. 业务侧stakeholder对项目的本身需求的澄清. 项目预算的规划和申请, 达到什么样的服务水平, SLA的定义
		- 项目的预算阶段. 对供应商进行基本的询价
	- 项目过程中, 网络团队, 不顾现场条件, 强行提出割接需求. 调动过多的资源(供应商, 非工作时间), 按照项目进度和优先级, 客户需求和反应进行协调. 事后追溯, 调整协作团队接口人, 供应商体系优化, 为未来的项目提升交付效率和质量 (菜鸟的网络团队瞎指挥, Lazada的网络团队跳过项目管理, 直接知道第三方工程师工作, 一线工程师和远程工程师的话语权问题, 谁接近客户谁有话语群, 项目经理最接近客户)


# 学习 PMP 的目的
- 从现在 8 月到 10 月, 2 个月的时间, 我要完成 AIDC 的项目, 这是一个 project. 这并不是我接触的第一个项目, 但是希望利用这个机会去学习一套项目管理的最佳实践. 并在实践的过程中, 最大话吸收和思考交付交付的方法论. 
- 我的职业生吧. 系统的学习之后, 从此在自己的开发和工作中, 逐渐去观察和磨练这部分技能
...
Projects enable change 项目造成的变化
...
Hybrid you combine the predictive and adaptive approach
